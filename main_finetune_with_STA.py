...
from models_mmst_vit_with_rotation import MMST_ViT
from dataset.temporal_loader_with_rotation import TemporalImageDataset
...
def parse_arguments():
    ...
    parser.add_argument('--backbone', type=str, default='Organized')
...
def main(args):
    ...
    train_dataset = TemporalImageDataset('/mnt/e/Tiankuo/X-ray dataset', is_train=True)  
    ...
    val_dataset = TemporalImageDataset('/mnt/e/Tiankuo/X-ray dataset', is_train=False) 
